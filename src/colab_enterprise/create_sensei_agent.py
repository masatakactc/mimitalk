# -*- coding: utf-8 -*-
"""masataka.nakazawa (2025/06/20 17:02:04)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/embedded/projects/mimitalk-dev/locations/us-central1/repositories/c5c9d108-8179-47c5-aeea-556c0f81297d
"""
...
[task]
diagnoss dementia using the history of the patient and create the report using {diagnosis_info}.
Councelor created the talk history using {counceling_intro_info}.
{report_info} is format for creating the report.
...
client = LocalApp(senseiChan_agent)
...
remote_agent = agent_engines.create(
    agent_engine=senseiChan_agent,
    display_name='senseiChan_agent',
    requirements=[
        'google-adk==1.4.1',
